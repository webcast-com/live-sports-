/**
 * Brand icons removed from lucide-react v1 (brand icons are no longer
 * shipped by lucide). These lightweight inline SVGs replace the old
 * `Chrome`, `Facebook`, `Instagram`, `Twitter` and `Youtube` lucide icons.
 */
...
export { TwitterIcon, YoutubeIcon, InstagramIcon, FacebookIcon, GoogleIcon };
